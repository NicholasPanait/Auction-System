...
testAMUser      AM 000000.00 password
"""
...
03 testItemsghsjldfhgjksfhdjkgsdfh testAMUser      10 100.00
00 testAMUser      AM 000000.00
"""
...
def test_advertise6(capsys):
	...
	try:
		...
		assert capsys.readouterr().out == "Error: Incorrect formatting for Advertise in Daily Transaction File\n"
