...
testFSUser      FS 999990.00 password
...
def test_add_credit6(capsys):
	...
	try:
		...
		assert capsys.readouterr().out == "ERROR: This add credit transaction would put the user over the limit.\n"
